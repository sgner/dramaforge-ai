...
export const ComposerPanel: React.FC = React.memo(() => {
  ...
  const handleRun = useCallback(() => {
    ...
    if (apiKind === 'video' || selectedNode.type === 'video') {
      ...
      if (!finalPrompt.trim() || providerId === 'default') return;
  ...
  }, [selectedNode, apiKind, promptText, inputPromptText, providerId, modelId, enabledProviders, inputImages, runVideoGeneration, updateNode, retryFailedAsset]);
    ...
    >
      <div className="composer-card">
        ...
        <div className="composer-actions">
          ...
          <button className="run-btn" type="button" onMouseDown={(e) => e.stopPropagation()} onClick={handleRun}>
